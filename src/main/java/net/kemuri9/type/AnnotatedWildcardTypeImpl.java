...
public final class AnnotatedWildcardTypeImpl extends AnnotatedTypeImpl implements AnnotatedWildcardType {
     ...
     *  is {@code null}</li>
     * <li>When {@code type.}{@link AnnotatedWildcardType#getAnnotatedUpperBounds() getAnnotatedUpperBounds()}
     *  does not match {@code type.}{@link AnnotatedWildcardType#getType() getType()}{@code .}{@link WildcardType#getUpperBounds() getUpperBounds()} typing</ul>
     ...
     * <li>When {@code type.}{@link WildcardType#getUpperBounds() getUpperBounds()} contains a {@code null}</li></ul>
     */
     ...
     * <li>When any element of {@code upperBoundAnns} contains a {@code null}</li></ul>
     * @see #AnnotatedWildcardTypeImpl(WildcardType)
     */
     ...
     * <li>When {@code upperBounds} specifies any annotated type that does not match the respective upper boundary on {@code type}</li></ul>
     * @see #AnnotatedWildcardTypeImpl(WildcardType)
     */
    public AnnotatedWildcardTypeImpl(WildcardType type, Annotation[] typeAnnotations,
